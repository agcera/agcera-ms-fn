    ...
    <Form action="" method="post" control={control} onSubmit={handleSubmit(onSubmit)}>
      <Box className="w-full h-full">
        ...
        <Box className="flex flex-col px-4 mb-4 gap-2">
          ...
          {!image ? (
            <Box
              component="label"
              htmlFor="image"
              className="flex border border-dashed rounded-md p-2 max-w-[500px] w-full h-full aspect-[2/1] cursor-pointer hover:bg-light-blue-50/50"
            >
              <Typography variant="subHeader" color="secondary.light" className="text-center m-auto font-medium">
        ...
        <Stack direction="row-reverse" spacing={2} className="px-4 mb-4">
          ...
          <LoadingButton loading={loading} type="submit" className="max-w-[175px] w-full">
            Add product
          </LoadingButton>
        </Stack>
      </Box>
